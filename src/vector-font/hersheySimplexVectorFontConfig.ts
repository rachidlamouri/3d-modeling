/** Every 2 numbers are the x and y coordinates of a point, and 'undefined' represents the end of a path of points */
type PathConfig = (number | undefined);

type CharacterVectorConfig = [width: number, ...paths:PathConfig[]];

type HersheySimplexVectorFontConfig = {
  height: number;
  characterConfigByCharacterCode: Record<number, CharacterVectorConfig>;
};

export const hersheySimplexVectorFontConfig: HersheySimplexVectorFontConfig = {
  height: 14,
  characterConfigByCharacterCode: {
    32: [16],
